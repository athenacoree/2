...
from care_clear_crew.ui.components import get_stepper, inject_styles
...
class TestUserInterface(BaseTestCase):
    ...
    def test_dynamic_precheck_score_rendering(self):
        ...
        from care_clear_crew.schemas import PrecheckReport
        from care_clear_crew.ui.components import display_precheck
        import streamlit as st
        from unittest.mock import patch
