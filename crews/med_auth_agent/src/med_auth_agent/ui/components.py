...
def render_header():
    st.markdown('<div class="main-header"><div class="brand"><div class="brand-logo">🩺</div><div><div class="brand-name">MedAuthAgent</div></div></div></div>', unsafe_allow_html=True)
